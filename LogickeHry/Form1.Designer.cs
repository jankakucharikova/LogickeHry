namespace LogickeHry
{
    partial class GameForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            MinyUvodRBStredni = new RadioButton();
            MinyUvodRBTezke = new RadioButton();
            MinyUvodRBVlastni = new RadioButton();
            MinyUvodLVyska = new Label();
            MinyUvodLSirka = new Label();
            MinyUvodLPocMin = new Label();
            MinyUvodNVyska = new NumericUpDown();
            MinyUvodNSirka = new NumericUpDown();
            MinyUvodNPocMin = new NumericUpDown();
            MinyUvodBNavod = new Button();
            MinyUvodBStatistika = new Button();
            MinyUvodBHrat = new Button();
            pictureBox1 = new PictureBox();
            MinyHraBox = new TableLayoutPanel();
            MinyHraBRestart = new Button();
            MinyHraBHint = new Button();
            MinyHraLZbyvajiciPolicka = new Label();
            MinyHraLPocZbyvajiciPolicka = new Label();
            MinyHraBUkoncitHru = new Button();
            MinyHraLBomby = new Label();
            ...
            MinyUvodBox.SuspendLayout();
            MinyUvodGBObtiznost.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)MinyUvodNVyska).BeginInit();
            ((System.ComponentModel.ISupportInitialize)MinyUvodNSirka).BeginInit();
            ((System.ComponentModel.ISupportInitialize)MinyUvodNPocMin).BeginInit();
            ((System.ComponentModel.ISupportInitialize)pictureBox1).BeginInit();
            MinyHraBox.SuspendLayout();
            SuspendLayout();
            // 
            // PrihlaseniBox
            // 
            ...
            HlavniBLogik.Size = new Size(94, 29);
            ...
            // MinyUvodBox
            // 
            MinyUvodBox.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyUvodBox.AutoSize = true;
            MinyUvodBox.ColumnCount = 3;
            MinyUvodBox.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 70F));
            MinyUvodBox.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 15F));
            MinyUvodBox.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 15F));
            MinyUvodBox.Controls.Add(MinyUvodGBObtiznost, 1, 0);
            MinyUvodBox.Controls.Add(MinyUvodLVyska, 1, 3);
            MinyUvodBox.Controls.Add(MinyUvodLSirka, 1, 4);
            MinyUvodBox.Controls.Add(MinyUvodLPocMin, 1, 5);
            MinyUvodBox.Controls.Add(MinyUvodNVyska, 2, 3);
            MinyUvodBox.Controls.Add(MinyUvodNSirka, 2, 4);
            MinyUvodBox.Controls.Add(MinyUvodNPocMin, 2, 5);
            MinyUvodBox.Controls.Add(MinyUvodBNavod, 1, 6);
            MinyUvodBox.Controls.Add(MinyUvodBStatistika, 1, 7);
            MinyUvodBox.Controls.Add(MinyUvodBHrat, 1, 8);
            MinyUvodBox.Controls.Add(pictureBox1, 0, 0);
            MinyUvodBox.GrowStyle = TableLayoutPanelGrowStyle.FixedSize;
            MinyUvodBox.Location = new Point(0, 200);
            MinyUvodBox.Name = "MinyUvodBox";
            MinyUvodBox.RowCount = 9;
            MinyUvodBox.RowStyles.Add(new RowStyle(SizeType.Percent, 11.1111107F));
            MinyUvodBox.RowStyles.Add(new RowStyle(SizeType.Percent, 11.1111107F));
            MinyUvodBox.RowStyles.Add(new RowStyle(SizeType.Percent, 11.1111107F));
            MinyUvodBox.RowStyles.Add(new RowStyle(SizeType.Percent, 11.1111107F));
            MinyUvodBox.RowStyles.Add(new RowStyle(SizeType.Percent, 11.1111107F));
            ...
            // MinyUvodGBObtiznost
            // 
            MinyUvodGBObtiznost.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyUvodBox.SetColumnSpan(MinyUvodGBObtiznost, 2);
            MinyUvodGBObtiznost.Controls.Add(MinyUvodRBLehke);
            MinyUvodGBObtiznost.Controls.Add(MinyUvodRBStredni);
            MinyUvodGBObtiznost.Controls.Add(MinyUvodRBTezke);
            MinyUvodGBObtiznost.Controls.Add(MinyUvodRBVlastni);
            MinyUvodGBObtiznost.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodGBObtiznost.Location = new Point(773, 3);
            MinyUvodGBObtiznost.Name = "MinyUvodGBObtiznost";
            MinyUvodBox.SetRowSpan(MinyUvodGBObtiznost, 3);
            MinyUvodGBObtiznost.Size = new Size(325, 159);
            MinyUvodGBObtiznost.TabIndex = 1;
            MinyUvodGBObtiznost.TabStop = false;
            MinyUvodGBObtiznost.Text = "Obtížnost";
            // 
            // MinyUvodRBLehke
            // 
            MinyUvodRBLehke.AutoSize = true;
            MinyUvodRBLehke.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodRBLehke.Location = new Point(22, 56);
            MinyUvodRBLehke.Name = "MinyUvodRBLehke";
            MinyUvodRBLehke.Size = new Size(83, 32);
            MinyUvodRBLehke.TabIndex = 3;
            MinyUvodRBLehke.TabStop = true;
            MinyUvodRBLehke.Text = "Lehké";
            MinyUvodRBLehke.UseVisualStyleBackColor = true;
            // 
            // MinyUvodRBStredni
            // 
            MinyUvodRBStredni.AutoSize = true;
            MinyUvodRBStredni.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodRBStredni.Location = new Point(180, 56);
            MinyUvodRBStredni.Name = "MinyUvodRBStredni";
            MinyUvodRBStredni.Size = new Size(95, 32);
            MinyUvodRBStredni.TabIndex = 2;
            MinyUvodRBStredni.TabStop = true;
            MinyUvodRBStredni.Text = "Střední";
            MinyUvodRBStredni.UseVisualStyleBackColor = true;
            // 
            // MinyUvodRBTezke
            // 
            MinyUvodRBTezke.AutoSize = true;
            MinyUvodRBTezke.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodRBTezke.Location = new Point(22, 105);
            MinyUvodRBTezke.Name = "MinyUvodRBTezke";
            MinyUvodRBTezke.Size = new Size(80, 32);
            MinyUvodRBTezke.TabIndex = 1;
            MinyUvodRBTezke.TabStop = true;
            MinyUvodRBTezke.Text = "Těžké";
            MinyUvodRBTezke.UseVisualStyleBackColor = true;
            // 
            // MinyUvodRBVlastni
            // 
            MinyUvodRBVlastni.AutoSize = true;
            MinyUvodRBVlastni.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodRBVlastni.Location = new Point(180, 105);
            MinyUvodRBVlastni.Name = "MinyUvodRBVlastni";
            MinyUvodRBVlastni.Size = new Size(91, 32);
            MinyUvodRBVlastni.TabIndex = 0;
            MinyUvodRBVlastni.TabStop = true;
            MinyUvodRBVlastni.Text = "Vlastní";
            MinyUvodRBVlastni.UseVisualStyleBackColor = true;
            // 
            // MinyUvodLVyska
            // 
            MinyUvodLVyska.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyUvodLVyska.AutoSize = true;
            MinyUvodLVyska.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodLVyska.Location = new Point(773, 165);
            MinyUvodLVyska.Name = "MinyUvodLVyska";
            MinyUvodLVyska.Size = new Size(159, 55);
            MinyUvodLVyska.TabIndex = 4;
            MinyUvodLVyska.Text = "Výška";
            MinyUvodLVyska.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // MinyUvodLSirka
            // 
            MinyUvodLSirka.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyUvodLSirka.AutoSize = true;
            MinyUvodLSirka.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodLSirka.Location = new Point(773, 220);
            MinyUvodLSirka.Name = "MinyUvodLSirka";
            MinyUvodLSirka.Size = new Size(159, 55);
            MinyUvodLSirka.TabIndex = 5;
            MinyUvodLSirka.Text = "Šířka";
            MinyUvodLSirka.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // MinyUvodLPocMin
            // 
            MinyUvodLPocMin.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyUvodLPocMin.AutoEllipsis = true;
            MinyUvodLPocMin.AutoSize = true;
            MinyUvodLPocMin.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodLPocMin.Location = new Point(773, 275);
            MinyUvodLPocMin.Name = "MinyUvodLPocMin";
            MinyUvodLPocMin.Size = new Size(159, 55);
            MinyUvodLPocMin.TabIndex = 6;
            MinyUvodLPocMin.Text = "Počet min";
            MinyUvodLPocMin.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // MinyUvodNVyska
            // 
            MinyUvodNVyska.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyUvodNVyska.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodNVyska.Location = new Point(938, 168);
            MinyUvodNVyska.Minimum = new decimal(new int[] { 5, 0, 0, 0 });
            MinyUvodNVyska.Name = "MinyUvodNVyska";
            MinyUvodNVyska.Size = new Size(160, 41);
            MinyUvodNVyska.TabIndex = 8;
            MinyUvodNVyska.Value = new decimal(new int[] { 5, 0, 0, 0 });
            // 
            // MinyUvodNSirka
            // 
            MinyUvodNSirka.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyUvodNSirka.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodNSirka.Location = new Point(938, 223);
            MinyUvodNSirka.Minimum = new decimal(new int[] { 5, 0, 0, 0 });
            MinyUvodNSirka.Name = "MinyUvodNSirka";
            MinyUvodNSirka.Size = new Size(160, 41);
            MinyUvodNSirka.TabIndex = 9;
            MinyUvodNSirka.Value = new decimal(new int[] { 5, 0, 0, 0 });
            // 
            // MinyUvodNPocMin
            // 
            MinyUvodNPocMin.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyUvodNPocMin.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodNPocMin.Location = new Point(938, 278);
            MinyUvodNPocMin.Minimum = new decimal(new int[] { 5, 0, 0, 0 });
            MinyUvodNPocMin.Name = "MinyUvodNPocMin";
            MinyUvodNPocMin.Size = new Size(160, 41);
            MinyUvodNPocMin.TabIndex = 10;
            MinyUvodNPocMin.Value = new decimal(new int[] { 5, 0, 0, 0 });
            // 
            // MinyUvodBNavod
            // 
            MinyUvodBNavod.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyUvodBNavod.AutoSize = true;
            MinyUvodBox.SetColumnSpan(MinyUvodBNavod, 2);
            MinyUvodBNavod.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodBNavod.Location = new Point(773, 333);
            MinyUvodBNavod.Name = "MinyUvodBNavod";
            MinyUvodBNavod.Size = new Size(325, 49);
            ...
            // MinyUvodBStatistika
            // 
            MinyUvodBStatistika.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyUvodBStatistika.AutoSize = true;
            MinyUvodBox.SetColumnSpan(MinyUvodBStatistika, 2);
            MinyUvodBStatistika.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyUvodBStatistika.Location = new Point(773, 388);
            MinyUvodBStatistika.Name = "MinyUvodBStatistika";
            MinyUvodBStatistika.Size = new Size(325, 49);
            MinyUvodBStatistika.TabIndex = 12;
            MinyUvodBStatistika.Text = "Statistika";
            MinyUvodBStatistika.UseVisualStyleBackColor = true;
            // 
            // MinyUvodBHrat
            // 
            MinyUvodBHrat.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyUvodBHrat.AutoSize = true;
            MinyUvodBox.SetColumnSpan(MinyUvodBHrat, 2);
            MinyUvodBHrat.Font = new Font("Segoe UI", 15F, FontStyle.Bold, GraphicsUnit.Point);
            MinyUvodBHrat.Location = new Point(773, 443);
            MinyUvodBHrat.Name = "MinyUvodBHrat";
            MinyUvodBHrat.Size = new Size(325, 54);
            MinyUvodBHrat.TabIndex = 13;
            MinyUvodBHrat.Text = "Hrát";
            MinyUvodBHrat.UseVisualStyleBackColor = true;
            MinyUvodBHrat.Click += MinyUvodBHrat_Click;
            // 
            // pictureBox1
            // 
            ...
            MinyUvodBox.SetRowSpan(pictureBox1, 9);
            pictureBox1.Size = new Size(764, 494);
            ...
            // MinyHraBox
            // 
            MinyHraBox.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            MinyHraBox.AutoSize = true;
            MinyHraBox.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            MinyHraBox.ColumnCount = 3;
            MinyHraBox.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 70F));
            MinyHraBox.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 20F));
            MinyHraBox.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 10F));
            MinyHraBox.Controls.Add(MinyHraBRestart, 1, 4);
            MinyHraBox.Controls.Add(MinyHraBHint, 1, 3);
            MinyHraBox.Controls.Add(MinyHraLZbyvajiciPolicka, 1, 2);
            MinyHraBox.Controls.Add(MinyHraLPocZbyvajiciPolicka, 2, 2);
            MinyHraBox.Controls.Add(MinyHraBUkoncitHru, 1, 5);
            MinyHraBox.Controls.Add(MinyHraLBomby, 1, 1);
            MinyHraBox.Controls.Add(MinyHraLPocBomby, 2, 1);
            MinyHraBox.Controls.Add(MinyHraLCas, 1, 0);
            MinyHraBox.Controls.Add(MinyHraTPlocha, 0, 0);
            MinyHraBox.Location = new Point(0, 200);
            MinyHraBox.Name = "MinyHraBox";
            MinyHraBox.RowCount = 6;
            MinyHraBox.RowStyles.Add(new RowStyle(SizeType.Percent, 16.6666718F));
            MinyHraBox.RowStyles.Add(new RowStyle(SizeType.Percent, 16.6666679F));
            MinyHraBox.RowStyles.Add(new RowStyle(SizeType.Percent, 16.6666679F));
            MinyHraBox.RowStyles.Add(new RowStyle(SizeType.Percent, 16.6666679F));
            MinyHraBox.RowStyles.Add(new RowStyle(SizeType.Percent, 16.6666679F));
            MinyHraBox.RowStyles.Add(new RowStyle(SizeType.Percent, 16.6666679F));
            ...
            // MinyHraBRestart
            // 
            MinyHraBRestart.AutoSize = true;
            MinyHraBRestart.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            MinyHraBox.SetColumnSpan(MinyHraBRestart, 2);
            MinyHraBRestart.Dock = DockStyle.Fill;
            MinyHraBRestart.Font = new Font("Segoe UI", 15F, FontStyle.Bold, GraphicsUnit.Point);
            MinyHraBRestart.Location = new Point(773, 335);
            MinyHraBRestart.Name = "MinyHraBRestart";
            MinyHraBRestart.Size = new Size(324, 77);
            MinyHraBRestart.TabIndex = 0;
            MinyHraBRestart.Text = "Restart";
            MinyHraBRestart.UseVisualStyleBackColor = true;
            // 
            // MinyHraBHint
            // 
            MinyHraBHint.AutoSize = true;
            MinyHraBHint.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            MinyHraBox.SetColumnSpan(MinyHraBHint, 2);
            MinyHraBHint.Dock = DockStyle.Fill;
            MinyHraBHint.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyHraBHint.Location = new Point(773, 252);
            MinyHraBHint.Name = "MinyHraBHint";
            MinyHraBHint.Size = new Size(324, 77);
            ...
            // 
            MinyHraLZbyvajiciPolicka.AutoSize = true;
            MinyHraLZbyvajiciPolicka.Dock = DockStyle.Fill;
            MinyHraLZbyvajiciPolicka.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyHraLZbyvajiciPolicka.Location = new Point(773, 166);
            MinyHraLZbyvajiciPolicka.Name = "MinyHraLZbyvajiciPolicka";
            MinyHraLZbyvajiciPolicka.Size = new Size(214, 83);
            MinyHraLZbyvajiciPolicka.TabIndex = 2;
            MinyHraLZbyvajiciPolicka.Text = "Zbývající políčka:";
            MinyHraLZbyvajiciPolicka.TextAlign = ContentAlignment.MiddleRight;
            // 
            // MinyHraLPocZbyvajiciPolicka
            // 
            MinyHraLPocZbyvajiciPolicka.AutoSize = true;
            MinyHraLPocZbyvajiciPolicka.Dock = DockStyle.Fill;
            MinyHraLPocZbyvajiciPolicka.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyHraLPocZbyvajiciPolicka.Location = new Point(993, 166);
            MinyHraLPocZbyvajiciPolicka.Name = "MinyHraLPocZbyvajiciPolicka";
            MinyHraLPocZbyvajiciPolicka.Size = new Size(104, 83);
            MinyHraLPocZbyvajiciPolicka.TabIndex = 3;
            MinyHraLPocZbyvajiciPolicka.Text = "15485136";
            MinyHraLPocZbyvajiciPolicka.TextAlign = ContentAlignment.MiddleLeft;
            // 
            // MinyHraBUkoncitHru
            // 
            MinyHraBUkoncitHru.AutoSize = true;
            MinyHraBUkoncitHru.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            MinyHraBox.SetColumnSpan(MinyHraBUkoncitHru, 2);
            MinyHraBUkoncitHru.Dock = DockStyle.Fill;
            MinyHraBUkoncitHru.Font = new Font("Segoe UI", 15F, FontStyle.Bold, GraphicsUnit.Point);
            MinyHraBUkoncitHru.Location = new Point(773, 418);
            MinyHraBUkoncitHru.Name = "MinyHraBUkoncitHru";
            MinyHraBUkoncitHru.Size = new Size(324, 77);
            ...
            // MinyHraLBomby
            // 
            MinyHraLBomby.AutoSize = true;
            MinyHraLBomby.Dock = DockStyle.Fill;
            MinyHraLBomby.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyHraLBomby.ImageAlign = ContentAlignment.MiddleRight;
            MinyHraLBomby.Location = new Point(773, 83);
            MinyHraLBomby.Name = "MinyHraLBomby";
            MinyHraLBomby.Size = new Size(214, 83);
            MinyHraLBomby.TabIndex = 5;
            MinyHraLBomby.Text = "Počet zbývajících bomb";
            MinyHraLBomby.TextAlign = ContentAlignment.MiddleRight;
            // 
            // MinyHraLPocBomby
            // 
            MinyHraLPocBomby.AutoSize = true;
            MinyHraLPocBomby.Cursor = Cursors.Cross;
            MinyHraLPocBomby.Dock = DockStyle.Fill;
            MinyHraLPocBomby.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyHraLPocBomby.Location = new Point(993, 83);
            MinyHraLPocBomby.Name = "MinyHraLPocBomby";
            MinyHraLPocBomby.Size = new Size(104, 83);
            ...
            // MinyHraLCas
            // 
            MinyHraLCas.AutoSize = true;
            MinyHraBox.SetColumnSpan(MinyHraLCas, 2);
            MinyHraLCas.Dock = DockStyle.Fill;
            MinyHraLCas.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            MinyHraLCas.Location = new Point(773, 0);
            MinyHraLCas.Name = "MinyHraLCas";
            MinyHraLCas.Size = new Size(324, 83);
            MinyHraLCas.TabIndex = 7;
            MinyHraLCas.Text = "Čas";
            MinyHraLCas.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // MinyHraTPlocha
            // 
            MinyHraTPlocha.ColumnCount = 2;
            MinyHraTPlocha.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            MinyHraTPlocha.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            MinyHraTPlocha.Dock = DockStyle.Fill;
            MinyHraTPlocha.Location = new Point(3, 3);
            MinyHraTPlocha.Name = "MinyHraTPlocha";
            MinyHraTPlocha.RowCount = 2;
            MinyHraBox.SetRowSpan(MinyHraTPlocha, 6);
            MinyHraTPlocha.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
            MinyHraTPlocha.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
            ...
            MinyUvodBox.ResumeLayout(false);
            MinyUvodBox.PerformLayout();
            MinyUvodGBObtiznost.ResumeLayout(false);
            MinyUvodGBObtiznost.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)MinyUvodNVyska).EndInit();
            ((System.ComponentModel.ISupportInitialize)MinyUvodNSirka).EndInit();
            ((System.ComponentModel.ISupportInitialize)MinyUvodNPocMin).EndInit();
            ((System.ComponentModel.ISupportInitialize)pictureBox1).EndInit();
            MinyHraBox.ResumeLayout(false);
            MinyHraBox.PerformLayout();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private GroupBox MinyUvodGBObtiznost;
        private RadioButton MinyUvodRBLehke;
        private RadioButton MinyUvodRBStredni;
        private RadioButton MinyUvodRBTezke;
        private RadioButton MinyUvodRBVlastni;
        private Label MinyUvodLVyska;
        private Label MinyUvodLSirka;
        private Label MinyUvodLPocMin;
        private Button MinyUvodBNavod;
        private Button MinyUvodBStatistika;
        private Button MinyUvodBHrat;
        ...
        private Label MinyHraLBomby;
        internal NumericUpDown MinyUvodNVyska;
        internal NumericUpDown MinyUvodNSirka;
        internal NumericUpDown MinyUvodNPocMin;
        internal Label MinyHraLPocZbyvajiciPolicka;
